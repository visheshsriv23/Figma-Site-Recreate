  ...
  return (
    <section className="w-full bg-[#FACC15] relative overflow-hidden h-[654px] sm:h-[500px] lg:h-[598px] flex justify-center items-center">
      <img 
        ...
        alt="" 
        className="absolute left-0 top-[5%] h-[90%] w-auto pointer-events-none select-none hidden sm:block object-contain object-left z-0"
      />
      <img 
        src={FloatingCardsRight} 
        alt="" 
        className="absolute right-0 top-[5%] h-[90%] w-auto pointer-events-none select-none hidden sm:block object-contain object-right z-0"
      />
      <div className="absolute inset-0 w-full h-full block sm:hidden pointer-events-none z-0">
        <img 
          src={FloatingCardsUp} 
          alt="" 
          className="absolute left-1/2 -translate-x-1/2 top-0 w-[100%] w-[361px] h-[150.12px] object-contain" 
        />
        <img 
          src={FloatingCardsDown} 
          alt="" 
          className="absolute left-1/2 -translate-x-1/2 bottom-0 w-[100%] w-[353px] h-[150px] object-contain" 
        />
      </div>
