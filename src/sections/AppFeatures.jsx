      ...
      <div className="w-full max-w-[1440px] px-6 sm:px-12 lg:px-[80px] grid grid-cols-1 lg:grid-cols-12 gap-[40px] lg:gap-[60px] items-center">
        <div className="w-full lg:col-span-5 flex flex-col space-y-[32px] text-left max-w-[544px]">
          <div className="space-y-4">
            <h2 className="text-[36px] sm:text-[44px] font-black tracking-tight text-[#111827] leading-[1.15]">
              An{' '}
              <span className="relative inline-block">
                all-in-one
                <span className="absolute bottom-[4px] left-0 w-full h-[10px] bg-[#FB923C] rounded-full -z-10" />
              </span>{' '}
              app <br />
              that makes it easier
            </h2>
          </div>
          <ul className="flex flex-col space-y-4 text-sm sm:text-base text-gray-500 font-medium">
        ...
        <div className="w-full lg:col-span-7 relative flex items-center justify-center lg:justify-end min-h-[520px] sm:min-h-[580px] bg-transparent">
          <img 
            src={OrangeBlob} 
            alt="" 
            className="absolute left-[-40px] lg:left-[10px] top-[20px] w-[320px] sm:w-[440px] lg:w-[506.18px] lg:h-[448.01px] pointer-events-none z-0"
          ...
          <div className="relative w-full max-w-[600px] bg-transparent">
            ...
            <div className="absolute -bottom-[50px] sm:-bottom-[70px] left-1/2 -translate-x-1/2 w-[94%] max-w-[560px] lg:max-w-[560px] grid grid-cols-3 gap-2.5 sm:gap-3.5 z-20">
            <div className="bg-white rounded-[10px] p-2.5 sm:p-3.5 border border-gray-100 shadow-[0px_6px_20px_rgba(0,0,0,0.03)] flex flex-col justify-between min-h-[165px] sm:min-h-[180px] text-left">
                ...
                <p className="text-[8px] sm:text-[10.5px] text-gray-400 font-normal leading-normal line-clamp-3">
