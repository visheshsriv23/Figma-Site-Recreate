...
export default function AppFeatures() {
  ...
  />
          <div className="relative w-full max-w-[600px] bg-transparent">
            ...
            <div className="absolute -bottom-[140px] sm:-bottom-[70px] left-1/2 lg:left-[260px] -translate-x-1/2 w-[94%] max-w-[500px] lg:max-w-[560px] grid grid-cols-2 sm:grid-cols-3 gap-3.5 sm:gap-3.5 z-20">
