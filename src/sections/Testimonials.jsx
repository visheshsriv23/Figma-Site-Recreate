...
export default function Testimonials() {
  return (
    <section className="w-full bg-[#FFFFFF] flex justify-center overflow-hidden pt-20 pb-12 lg:pt-[84px] lg:pb-[80px]">
      <div className="w-full max-w-[1280px] px-6 sm:px-12 lg:px-0 flex flex-col space-y-8 lg:space-y-12">
        ...
        <div className="w-full flex flex-row gap-4 lg:gap-6 overflow-x-auto snap-x snap-mandatory scroll-smooth scrollbar-none -mx-6 px-6 sm:-mx-12 sm:px-12 lg:mx-0 lg:px-0 pb-6">
          <div 
            className="w-[290px] sm:w-[360px] lg:w-[412px] h-[320px] lg:h-[305px] shrink-0 bg-white rounded-[20px] p-6 lg:p-8 border border-gray-100 flex flex-col justify-between text-left snap-start shadow-[0px_10px_30px_rgba(0,0,0,0.04)]"
          >
            <p className="text-gray-600 text-sm sm:text-base font-medium leading-relaxed line-clamp-6 sm:line-clamp-5 lg:line-clamp-6">
